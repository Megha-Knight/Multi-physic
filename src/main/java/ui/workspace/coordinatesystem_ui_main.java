 ...
 */
public class coordinatesystem_ui_main extends Group {
    ...
    public coordinatesystem_ui_main() {
        buildGroundGrid();
        buildAxes();
        buildOrigin();
    }
    ...
    private void buildGroundGrid() {
        ...
        // Slightly enhanced contrast materials for clear visibility from all angles
